...
document.addEventListener('DOMContentLoaded', () => {
  ...
  "領導主管": [
    ...
    { q: "你知道資產除了成長外，還能隱藏資產不被公開，合法避稅也能兼具穩定現金流的功能嗎？", options: ["大概知道", "沒有頭緒"] },
  ...
  "計程車司機": [
    ...
    { q: "你知道你沒有6%勞退機制，退休時「勞退金」基本上是$0元 你知道？", options: ["不知道", "有聽聞"] },
    { q: "淡季／疫情期間載客少時會不會吃緊？", options: ["晚點下班就好", "稍微吃緊"] },
    { q: "萬一哪天身體不適無法開車幾天，收入中斷會不會影響家用", options: ["稍微影響","完全不影響"] },
    ...
    { q: "這筆錢除了可以讓你提早退休，亦有保障支撐，您有興趣了解怎麼操作嗎？", options: ["想了解", "可以考慮"] }
  ],
