...
/* ── 1. 題庫 (共 5 職業 × 9 題) ── */
const spinQuestions={               /* ← 如需改題目就在這裡改 */
 "一般上班族":[
  ...
  {q:"如果有個方式，每月幫你存一點…重要嗎？",options:["重要","還好"]},
  {q:"這方式像備用電池…想進一步了解嗎？",options:["想了解","觀望"]}
 ],
 "自營業者":[
  {q:"你目前生意穩定嗎？",options:["穩定","偶爾波動"]},
  {q:"你覺得當老闆一人多職辛苦嗎？",options:["可接受","略辛苦"]},
  {q:"你固定存錢？還是全部投入事業？",options:["固定存錢","少量存款","全部投入"]},
  {q:"老闆沒有勞退，你有自主退休/投資規劃嗎？",options:["部分有安排","還沒有想過"]},
  {q:"店面修繕/突發大筆支出壓力感？",options:["可應付","多少有壓力"]},
  {q:"估算過退休後支出嗎？",options:["已估算並準備","略擔心"]},
  {q:"若生病無法工作幾個月，開銷備案？",options:["部分準備","還沒有準備"]},
  {q:"每月撥幾千做備用金/退休準備，實用嗎？",options:["要看方案","不需要"]},
  {q:"這像替生意準備保險…想了解？",options:["想了解","再觀望"]}
 ],
 "領導主管":[
  {q:"你目前團隊工作量是否滿檔？",options:["非常忙碌","偶爾加班","時間彈性"]},
  {q:"領導公司同時會犧牲與家人時間嗎？",options:["常常犧牲","偶爾","無影響"]},
  {q:"你固定安排資產儲蓄嗎？",options:["固定儲蓄","部分儲蓄","幾乎不存"]},
  {q:"若生病休息幾個月，財務準備？",options:["部分準備","沒準備"]},
  {q:"目前收入足以支撐退休生活嗎？",options:["應該足夠","可能不足","完全不擔心"]},
  {q:"資產配置有長期穩定型保障嗎？",options:["部分有規劃","還沒有"]},
  {q:"考慮過讓資產同時產生現金流？",options:["已布局","正在考慮"]},
  {q:"每月撥小額打造保障，覺得？",options:["可以評估","暫不需要"]},
  {q:"這像替家庭建防線，有興趣？",options:["想了解","再觀望"]}
 ],
 "計程車司機":[
  {q:"您一天大約開幾小時？",options:["12小時以上","8到12小時","少於8小時"]},
  {q:"開車收入是否波動？",options:["很穩定","稍有波動"]},
  {q:"平均一月可存多少？",options:["超過2萬","5000-1萬","3000-5000"]},
  {q:"若無法跑車，有其他收入來源？",options:["部分收入","完全沒有"]},
  {q:"淡季/疫情少客時會吃緊嗎？",options:["晚點下班就好","稍微吃緊"]},
  {q:"身體不適影響收入，家用？",options:["稍微影響","完全不影響"]},
  {q:"車子大修或急需用錢壓力？",options:["能應付","稍微擔心"]},
  {q:"每月存2~5000做預備金，覺得？",options:["我不會車禍","會覺得好險"]},
  {q:"此筆錢可當退休補貼，想了解？",options:["想了解","可以考慮"]}
 ],
 "公職/醫療":[
  {q:"目前公部門/醫療單位工作還習慣嗎？",options:["還行","不太習慣"]},
  {q:"值班/輪班對健康或家庭影響？",options:["無影響","些微影響"]},
  {q:"有另外固定做儲蓄或投資嗎？",options:["少量儲蓄/投資","幾乎沒有"]},
  {q:"再額外規劃退休金了嗎？",options:["做過規劃","正在考慮"]},
  {q:"遇重大醫療支出時現金流夠嗎？",options:["應該足夠","可能不足"]},
  {q:"退休後每月生活費估算夠用嗎？",options:["應該夠","勉強夠"]},
  {q:"若制度調整或高風險停工，備案？",options:["應該有備案","還沒有想過"]},
  {q:"每月小額補醫療缺口&退休金，實用？",options:["可考慮","還好"]},
  {q:"多一層防護網，想深入了解？",options:["想了解","再看看"]}
 ]
};
...
function buildQuestions(){
 ...
 qs.forEach((item,i)=>{
   ...
   item.options.forEach(opt=>{
     form.insertAdjacentHTML('beforeend',`<div><input type="radio" name="q${i}" value="${opt}" required> ${opt}</div>`);
   });
 });
...
async function showResult(qs){
 ...
 await html2canvas(box,{scale:2});   /* 生成畫面供截圖 */
